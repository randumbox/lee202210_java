...
public class MainClass02 {
	 ...
	 *  
	 *  그 객체는 어디에 있나? System 클래스의 out 이라는 
	 *                    static 필드에 해당 객체의 참조값 (키값) 이 들어 있다.
	 *                    
	 *  그 객체는 무슨 type 인가? PrintStream type 이다.
	 *  
	 *  그 객체를 누가 생성했나? java 에서 이미 생성해서 미리 준비된 객체이다.
	 *  
	 *  System 클래스는 왜 import 안해도 사용할 수 있나
	 *  -> System, String 등의 클래스는 java.lang 패키지에 있는 클래스이며
	 *     해당 패키지에 있는 모든 클래스는 마치 기본 클래스처럼 import 없이 사용가능
	 */
	System.out.println("안녕하세요");
	//System.out.println - 메소드가 다중정의 되어 있다. = OverLoading
